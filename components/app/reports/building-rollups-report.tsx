    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 xl:px-8">
      <div className="mb-8">
        <PageHeader
          ...
          description={`Compare outstanding rent and overdue risk across ${orgName}.`}
          actions={
            <>
      ...
      <Card className="p-0">
        <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          <ButtonLink href={`/app/org/${orgSlug}/buildings-unpaid`} variant="tertiary" size="sm" className="w-full sm:w-auto">
        ...
        <CardContent>
          {isLoading && report ? (
            ...
            <EmptyState
              ...
              description="Due and overdue rent periods will be grouped here by building."
            />
          ) : (
